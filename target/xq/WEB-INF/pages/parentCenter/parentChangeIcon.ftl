...
<div class="row" style="margin-top: 10%; padding: 15px">
    ...
    <div class="col-xs-4" style="padding: 5px"><button class="btn btn-block m-btn" onclick="file.click()">选择</button></div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.success==true) {
                        window.location.href = "/wx/parentCenter/" + "${user.id}" + "/myInfo_base";
                    }
                },error:function () {
                    alert("出错了！");
                }});
