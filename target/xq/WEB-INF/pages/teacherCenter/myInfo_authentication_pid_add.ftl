...
<div id="main">
    <form action="/wx/teacherCenter/info/${user.id}/pid/0/edit" method="post">
        <div class="buttonDiv_info">
            <div class="info row" >
                ...
                <div class="col-xs-9">
                    <input placeholder="请输入证件号" name="title" type="text" class="title_input" maxlength="20" value="${data!}">
                </div>
            </div>
        </div>
