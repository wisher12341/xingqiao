...
<#else>
<form action="${path}/wx/comment" method="post" enctype="multipart/form-data">
    <input name="order.id" type="hidden" />

    <div class="start" align="center">
        <input id="input-21a" value="0" type="number" class="rating" min=0 max=5 step=1 data-size="xl" name="level" >
    </div>
