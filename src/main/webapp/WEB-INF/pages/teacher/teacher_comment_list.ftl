        ...
        function setListData(data){
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                str +='"/></div>' +
                        ...
                        '<div>' +
                        '<div class="user-name">'+ comm.user.username + '</div>' +
                        '<div class="comment-content" onclick="location=\'${base}/wx/teacher/toTeacherCommentSingle?cid=' + comm.id +'&tid=${teacherId}\'">' + comm.detail +'</div>' +
...
//                alert(pageNum);
                $.ajax({
                    type: 'POST',
                    url: '${base}/wx/teacher/getCommentByPage',
                    data:{
                        page:pageNum,
                        size:pageSize,
                        teacherId:${teacherId}
    ...
    function reply(pid) {
        ...
        window.location.href="${base}/wx/teacher/toReply?teacherId=${teacherId}&pid=" +pid;
