...
//        alert(JSON.stringify(events));
        ...
        $('#calendar_month').fullCalendar({
            ...
            eventClick : function( event ) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/wx/parentCenter/${user.id}/myWork/getDayWork",
                    dataType: "json",
                    data: {
                        date: date
                    },
