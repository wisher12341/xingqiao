    ...
    <div class="buttonDiv_info" style="background-color: white;margin-bottom: 8%">
        <ul>
            ...
            <li class="sl-li ui-border-b" style="background-color: white">
                ...
                <div class="sl-opts">
                    <i class="glyphicon glyphicon-trash" onclick="location.href='/wx/teacherCenter/info/${uid}/recoveryHis/${rec_index}/del'"></i>
                </div>
            </li>
            </#list>
        </ul>
...
<#else>
    <div class="foot" align="center">
        <button onclick="location.href='${path}/wx/teacherCenter/info/${uid}/recoveryHis/0'" style="width: 49% !important;">新增</button>
